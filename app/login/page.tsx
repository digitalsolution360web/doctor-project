    ...
    >
      ...
      >
        ...
        <div className="text-center mb-8">
          ...
          >
            <img src="/newlogo.webp" alt="Logo" style={{ width: "100%", height: "100%", objectFit: "contain" }} />
          </div>
          <h1
            style={{
              fontSize: "28px",
        ...
        >
          Midfloraherbal Management System © {new Date().getFullYear()}
        </p>
      </div>
    </div>
  );
