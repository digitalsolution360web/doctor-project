...
export default function CategoriesPage() {
  return (
    <div className="min-h-screen bg-slate-50 pt-24 pb-16 font-sans selection:bg-teal-500/30 relative overflow-hidden">
      ...
      <div className="text-center max-w-3xl mx-auto mb-12 px-4 relative z-10">
        <RevealOnScroll>
          ...
          <h1 className="text-4xl md:text-4xl lg:text-5xl font-black text-slate-900 mb-6 tracking-tighter">
      ...
      <div className="w-full max-w-7xl mx-auto h-px bg-gradient-to-r from-transparent via-slate-200 to-transparent mb-12"></div>

      {/* Categories Sections */}
      <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 flex flex-col gap-16">
