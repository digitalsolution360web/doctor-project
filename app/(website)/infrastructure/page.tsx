...
const statsData = [
  ...
  { num: 60000, suffix: "", title: "Tube Filling", sub: "Tubes Per Day Capacity", icon: Settings, img: "/Tube-FIlling.webp" },
  { num: 50000, suffix: "", title: "Bottle Filling", sub: "4-Head Servo Liquid", icon: Zap, img: "/Bottle-filling.webp" },
  { num: 60000, suffix: "", title: "Labeling Capacity", sub: "Units Per Day Capacity", icon: Factory, img: "/labeling-machines.webp" },
  { num: 40000, suffix: "", title: "Tube Sealing", sub: "Tube Per Day Capacity", icon: ShieldCheck, img: "/Tube-Sealing.webp" },
