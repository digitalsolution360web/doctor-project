    ...
    <section id="services" className="py-10 bg-white relative">
      <div className="container mx-auto px-4 md:px-6">
        <div className="flex flex-col mb-16 gap-4">
          ...
          <p className="text-slate-500 text-lg font-bold max-w-xl text-left leading-relaxed ">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {services.map((service, i) => (
            <div key={i} className="group relative bg-white p-6 rounded-[28px] border border-slate-100 shadow-[0_15px_40px_-20px_rgba(0,0,0,0.05)] hover:shadow-[0_40px_80px_-20px_rgba(20,184,166,0.15)] hover:border-teal-100 transition-all duration-700 hover:-translate-y-3 text-left overflow-hidden cursor-pointer">
