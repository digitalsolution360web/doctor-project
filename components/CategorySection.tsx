...
const CategorySection = () => {
  ...
  return (
    <section id="categories" className="py-16 bg-gray-200 relative overflow-hidden">
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        ...
        >
          {categories.map((cat, i) => (
            <div
              key={i}
              className="group relative min-w-[300px] md:min-w-[380px] shrink-0 snap-start bg-white rounded-[24px] shadow-[0_15px_60px_-20px_rgba(0,0,0,0.05)] overflow-hidden border border-slate-100 transition-all duration-700 hover:shadow-[0_40px_80px_-20px_rgba(20,184,166,0.15)] hover:border-teal-100 mb-10 cursor-pointer"
            >
              {/* Image Container (Top) */}
              ...
              <div className="p-6">
                ...
                <p className="text-slate-500 text-[11px] font-medium uppercase tracking-[0.2em] mb-5 opacity-60">
                  {cat.items}
                </p>
